...
export default function (data) {
  ...
  const response = http.get(
    `${BASE_URL}/associate/settings/getDriverDutyStatus`,
    params
  );

  console.log(`\n========================================`);
  console.log(`[SCENARIO]: Get Driver Duty Status API`);
  console.log(`[RESPONSE STATUS]: ${response.status}`);
  console.log(`[RESPONSE BODY]: ${response.body}`);
  console.log(`========================================\n`);

  check(response, {
    'Driver Duty Status Check': (res) =>
