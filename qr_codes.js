...
export default function (data) {
  ...
  // GET Request for QR Codes API
  const response = http.get(
    `${BASE_URL}/admin/qr-codes`,
    params
  );

  console.log(`\n========================================`);
  console.log(`[SCENARIO]: QR Codes API`);
  console.log(`[REQUEST URL]: ${BASE_URL}/admin/qr-codes`);
  console.log(`[RESPONSE STATUS]: ${response.status}`);
  console.log(`[RESPONSE BODY]: ${response.body}`);
  console.log(`========================================\n`);

  check(response, {
    'QR Codes API Status Check': (res) =>
